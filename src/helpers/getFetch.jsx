let productos=[
  ...
  {id: "4", categoria: "figuras", name: "Funko Pop!: Sauron ", price: 5000, foto: "src/img/funkpPopSauron.JPG"},
  {id: "5", categoria: "figuras", name: "Funko Pop!: Gollum", price: 5000, foto: "src/img/funkpPopSauron.JPG"}
]
